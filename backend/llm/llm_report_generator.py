...
def _summary(
    *,
    ...
    return {
        ...
        "draft_error_severity_distribution": quality_before.get("error_severity_distribution", {}),
        "final_error_severity_distribution": quality_after.get("error_severity_distribution", {}),
        "draft_weighted_error_penalty": quality_before.get("weighted_error_penalty"),
        "final_weighted_error_penalty": quality_after.get("weighted_error_penalty"),
        "draft_required_fact_coverage": (quality_before.get("required_fact_coverage") or {}).get("required_fact_coverage"),
        "final_required_fact_coverage": (quality_after.get("required_fact_coverage") or {}).get("required_fact_coverage"),
        ...
        "draft_support_status_distribution": trace_before.get("support_status_distribution", {}),
        "final_support_status_distribution": trace_after.get("support_status_distribution", {}),
        "draft_mismatch_type_distribution": trace_before.get("mismatch_type_distribution", {}),
        "final_mismatch_type_distribution": trace_after.get("mismatch_type_distribution", {}),
