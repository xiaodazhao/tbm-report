    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "7. 不得将 daily_excavated_scope 写成实际推进范围。",
            "8. 不得根据 daily_excavated_scope 自行计算推进量。",
            "9. 实际推进量只能使用 daily_plc_range.daily_advance_m。",
            "10. 实际推进起止只能使用 daily_plc_range.start_chainage 和 daily_plc_range.end_chainage。",
            "11. daily_excavated_scope 只能写作“10m cell 对齐后的已掘复核范围”。",
            "",
            "必须保留的章节：",
