...
def _strip_forward_plc_response_fields(payload: dict[str, Any]) -> None:
    ...
    for key in [
        ...
        "trial_30s_speed_mean",
        "trial_30s_speed_var",
        "trial_30s_thrust_mean",
        "trial_30s_thrust_var",
        "trial_30s_torque_mean",
        "trial_30s_torque_var",
        "trial_30s_rpm_mean",
        "trial_30s_rpm_var",
        "trial_30s_penetration_mean",
        "trial_30s_penetration_var",
    ]:
