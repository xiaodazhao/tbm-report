...
def register_report_routes(app: FastAPI) -> None:
    ...
    def build_report_debug(request: DailyReportRequest) -> dict:
        ...
        return {
            ...
            "trace": result.trace,
            "trace_summary": result.trace_summary,
            "daily_construction_twin": getattr(result, "daily_construction_twin", {}),
            "twin_summary": getattr(result, "twin_summary", {}),
            "twin_boundary_summary": getattr(result, "twin_boundary_summary", {}),
            "forward_profile": result.forward_profile,
            "high_grci_cells": result.high_grci_cells,
            "generation_mode": result.generation_mode,
